...
const reqTabletrigger = document.querySelector('.con4 .itrequestTable thead th:last-child img');
...
reqTabletrigger.addEventListener('click',(e)=>
{
   e.stopPropagation();
   let img = e.target.closest('tr').querySelector('th img');
